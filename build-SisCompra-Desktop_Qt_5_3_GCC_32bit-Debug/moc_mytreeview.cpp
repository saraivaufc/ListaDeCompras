...
#include "../SisCompra/mytreeview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyTreeView_t, stringdata) + ofs \
...
void MyTreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MyTreeView *_t = static_cast<MyTreeView *>(_o);
        switch (_id) {
        ...
        {
            typedef void (MyTreeView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTreeView::mouseClicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MyTreeView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_MyTreeView.data,
      qt_meta_data_MyTreeView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyTreeView.stringdata))
